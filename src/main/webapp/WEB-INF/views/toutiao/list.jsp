...
<div id="main">
    ...
    --%>
    <div id="container">
        <c:forEach var="toutiao" items="${toutiaos}">
            <div class="clear"></div>
            <section class="list">
                <div class="mecc">
                    <h2 class="mecctitle"><a href="${toutiao.url}" target="_blank">
                            ${toutiao.title}
                    </a></h2>
                </div>
       <span class="titleimg">
       <a href="${toutiao.url}" target="_blank">
           <img width="270" height="165" src="${toutiao.image}"
                ...
                <p>来自 ${toutiao.source}&nbsp;<a href="${toutiao.url}">点此查看全文</a></p>
